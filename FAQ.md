...
```sh
$ npm install sails-generator-new-but-like-express
```

[![NPM](https://nodei.co/npm/sails-generator-new-but-like-express.png?downloads=true&stars=true)](https://nodei.co/npm/sails-generator-new-but-like-express/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/sails-generator-new-but-like-express/FAQ.md)
