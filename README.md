...
sailsgen(require('sails-generate-new-but-like-express'), scope, function (err) {
	if (err) throw err;
...
```sh
$ git clone YOUR_FORK_OF_THIS_REPO sails-generate-new-but-like-express-fork
$ cd sails-generate-new-but-like-express-fork
$ npm install
$ node ./bin
```
