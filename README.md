...
sailsgen(require('sails-generator-new-but-like-express'), scope, function (err) {
	if (err) throw err;
...
```sh
$ git clone YOUR_FORK_OF_THIS_REPO sails-generator-new-but-like-express-fork
$ cd sails-generator-new-but-like-express-fork
$ npm install
$ node ./bin
```
